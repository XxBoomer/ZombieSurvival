            ...
            switch (strtolower(array_shift($args))):
                ...
                case 'join':
                    ...
                    if (!(count($args) < 0b11)) {
                        ...
                        $sender->sendMessage(TextFormat::AQUA . '→' . TextFormat::RED . 'Usage: /zs ' . TextFormat::GREEN . 'join [SWname]' . TextFormat::GRAY . ' [PlayerName]');
        ...
        switch (strtolower(array_shift($args))):
            ...
            case 'create':
                ...
                */
                ...
                if (!($SWname && preg_match('/^[a-z0-9]+[a-z0-9]$/i', $SWname) && strlen($ZSname) < 0x10 && strlen($ZSname) > 0b10)) {
